...
/**
 * Base class for unit tests for profilefield_hierarchicalmenu.
 *
 * @package    profilefield_hierarchicalmenu
 * @copyright  2018 Mihail Geshoski <mihail@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace profilefield_hierarchicalmenu\privacy;

defined('MOODLE_INTERNAL') || die();

use core_privacy\tests\provider_testcase;
use profilefield_hierarchicalmenu\privacy\provider;
use core_privacy\local\request\approved_userlist;

/**
 * Unit tests for profilefield_hierarchicalmenu\privacy\provider
 *
 * @package    profilefield_hierarchicalmenu
 * @copyright  2018 Mihail Geshoski <mihail@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
final class provider_test extends provider_testcase {
    ...
    public function test_get_contexts_for_userid(): void {
        ...
        $profilefieldid = $this->add_profile_field($categoryid, 'hierarchicalmenu');
        // Create a user.
    ...
    public function test_export_user_data(): void {
        ...
        $menuprofilefieldid = $this->add_profile_field($categoryid, 'hierarchicalmenu');
        ...
        $this->export_context_data_for_user($user->id, $context, 'profilefield_hierarchicalmenu');
        $data = $writer->get_data([get_string('pluginname', 'profilefield_hierarchicalmenu')]);
    ...
    public function test_delete_data_for_user(): void {
        ...
        $userinfodata = $DB->get_records('user_info_data', ['userid' => $user->id]);
        $this->assertCount(2, $userinfodata);
        $approvedlist = new \core_privacy\local\request\approved_contextlist($user, 'profilefield_hierarchicalmenu',
            [$context->id]);
    ...
    public function test_get_users_in_context(): void {
        ...
        $component = 'profilefield_hierarchicalmenu';
        // Create profile category.
        $categoryid = $this->add_profile_category();
        // Create menu profile field.
        $profilefieldid = $this->add_profile_field($categoryid, 'hierarchicalmenu');
